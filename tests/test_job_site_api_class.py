...
@pytest.fixture
def hh_fixture():
    return {'items': [{'id': '81910657', 'premium': False, 'name': 'Frontend-разработчик',
                       ...
                       'sort_point_distance': None, 'published_at': '2023-06-14T14:56:15+0300',
                       'created_at': '2023-06-14T14:56:15+0300', 'archived': False,
                       'apply_alternate_url': 'https://hh.ru/applicant/vacancy_response?vacancyId=81910657',
                       'insider_interview': None, 'url': 'https://api.hh.ru/vacancies/81910657?host=hh.ru',
                       'adv_response_url': None, 'alternate_url': 'https://hh.ru/vacancy/81910657',
                       'relations': [], 'employer':
                           {'id': '1178506', 'name': 'Нордавинд',
                            'url': 'https://api.hh.ru/employers/1178506',
                            'alternate_url': 'https://hh.ru/employer/1178506',
                            'logo_urls': {'original': 'https://hhcdn.ru/employer-logo-original/1056714.png',
                                          '90': 'https://hhcdn.ru/employer-logo/5847497.png',
                                          '240': 'https://hhcdn.ru/employer-logo/5847498.png'},
                            'vacancies_url': 'https://api.hh.ru/vacancies?employer_id=1178506',
                            'accredited_it_employer': True, 'trusted': True}, 'snippet':
                           {'requirement': 'Знание JavaScript (ES6, node, webpack, Lodash, Moment.js, jQuery), HTML5, CSS3, <highlighttext>Python</highlighttext>, React, TypeScript, SCSS Modules. - ',
                            'responsibility': 'Разработка приложения, являющегося клиентской частью программного комплекса, и интеграция его с ядром программы.'},
                       'contacts': None, 'schedule': None, 'working_days': [], 'working_time_intervals': [], 'working_time_modes': [], 'accept_temporary': False, 'professional_roles': [{'id': '96', 'name': 'Программист, разработчик'}], 'accept_incomplete_resumes': False, 'experience': {'id': 'between1And3', 'name': 'От 1 года до 3 лет'}, 'employment': {'id': 'full', 'name': 'Полная занятость'}}]}
...
def test_clean_vacancies_hh(hh_fixture):
    hh = HeadHunterAPI()
    assert hh.clean_vacancies(hh_fixture) == [{'title': 'Frontend-разработчик',
                                               'url': 'https://hh.ru/vacancy/81910657',
                                               'salary_from': 70000, 'employer': 'Нордавинд'}]


def test_clean_vacancies_sj(sj_fixture):
    sj = SuperJobAPI()
    assert sj.clean_vacancies(sj_fixture) == [{'title': 'Специалист службы поддержки',
                                               'url': 'https://www.superjob.ru/vakansii/specialist-sluzhby-podderzhki-37984527.html',
                                               'salary_from': 15000, 'employer': 'Яндекс/ООО "ЯНДЕКС"'}]
