...
def vacancies_fixture():
    return [{'title': 'Frontend-разработчик',
...
def test_filter_vacancies(vacancies_fixture, connector_fixture):
    ...
    assert connector_fixture.filter_vacancies("разработчик") == [{'title': 'Frontend-разработчик',
                                                                  'url': 'https://hh.ru/vacancy/81910657',
                                                                  'salary_from': 70000, 'employer': 'Нордавинд'}]
    connector_fixture.delete_vacancies()
...
def test_top_vacancies(vacancies_fixture, connector_fixture):
    connector_fixture.add_vacancies(vacancies_fixture)
    assert connector_fixture.top_vacancies(1) == [{'title': 'Frontend-разработчик',
                                                   'url': 'https://hh.ru/vacancy/81910657',
                                                   'salary_from': 70000, 'employer': 'Нордавинд'}]
    connector_fixture.delete_vacancies()
